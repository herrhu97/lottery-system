...
import com.herrhu.lottery.domain.strategy.service.draw.AbstractDrawBase;
...
public class DrawExecImpl extends AbstractDrawBase implements IDrawExec {
    ...
    protected List<String> queryExcludeAwardIds(Long strategyId) {
        List<String> noStockStrategyAwardList = strategyRepository.queryNoStockStrategyAwardList(strategyId);
        logger.info("执行抽奖策略id：{}，无库存排除奖品列表集合：{}", strategyId, JSON.toJSONString(noStockStrategyAwardList));
